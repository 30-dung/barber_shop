...
import 'booking_confirmation_screen.dart'; // Import this
  ...
  Future<void> _loadAvailableTimeSlots() async {
    ...
    try {
      ...
      setState(() {
        ...
        _availableTimeSlots = slots.where((slot) => slot.isAvailable).toList();
      ...
      MaterialPageRoute(
        builder:
            (context) => BookingConfirmationScreen(
              storeService:
                  widget.storeService, // Truyền toàn bộ đối tượng StoreService
              store: widget.store,
